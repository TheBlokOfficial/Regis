...
class RemoteClient:
    ...
    def generate_response(self, prompt: str, tools_registry, on_tool_call=None, on_thought_token=None, on_content_token=None, on_routing_info=None, on_done=None) -> str:
